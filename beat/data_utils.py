...
chords, abstract_grammars = get_musical_data('/content/drive/My Drive/Colab Notebooks/Beat/data/original_metheny.mid')
...
def generate_music(inference_model, corpus = corpus, abstract_grammars = abstract_grammars, tones = tones, tones_indices = tones_indices, indices_tones = indices_tones, T_y = 10, max_tries = 1000, diversity = 0.5):
    ...
    mf.open("/content/drive/My Drive/Colab Notebooks/Beat/output/my_music.midi", 'wb')
    mf.write()
